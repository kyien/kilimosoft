...
<div class="w3-col l8 ">
  ...
  <p>
  <label class="w3-text-grey"><h4>Tool Name:</h4>

    <input class="w3-input w3-border units" name="tool_name" type="text" value="" id="tool_name" >
